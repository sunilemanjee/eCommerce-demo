...
echo -e "${GREEN}Starting Rules E-commerce Search Application...${NC}"
...
echo -e "${GREEN}Starting Rules Flask application...${NC}"
echo -e "${BLUE}Application will be available at: http://localhost:8047${NC}"
echo -e "${BLUE}Press Ctrl+C to stop the application${NC}"

# Start the Rules Flask application
python rules_app.py
